...
// Map instance and state (using var to avoid conflicts with app.js)
var map = null;
var markerGroups = null;
var markers = {}; // Using var to avoid conflicts with app.js
var allMarkers = {}; // Using var to avoid conflicts with app.js
var currentMapMode = 'day'; // Using var to make it accessible from app.js
var dayLayer = null; // Using var to make it accessible from app.js
var nightLayer = null; // Using var to make it accessible from app.js
var satelliteLayer = null; // Using var to make it accessible from app.js
var toggleModeButton = null; // Using var to make it accessible from app.js
...
/**
 * Cleanup old markers outside time range
 * This is an alias for clearAllMarkers for backwards compatibility
 */
