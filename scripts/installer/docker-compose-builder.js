...
class DockerComposeBuilder {
  ...
  async build(services) {
    ...
    const shouldStartOllamaContainer = enableOllama && !ollamaUrl;
    const shouldStartICADContainer = enableICAD && !icadUrl;
    ...
    } else if (enableOllama && ollamaUrl) {
